...
def lettore(im, orario):
    """
    Ottiene in inglesso una colonna e ritorna le materie contenute separate da ":::"
        :param im: Colonna da elaborare
        :param orario: Orario dal quale viene la colonna (1,2,3)
        :return: Materie lette separate da ":::"
    """
    if orario == 1:
        righeUno = [
            [0, 175],
...
def img_to_string(img):
    """
    Converte la cella passata in ingresso in testo
        :param img: Cella divisa
